...
{
    // 初始化名称，UserMediator
    // 初始化了中介器的名称 MEDIATOR_NAME 为 "UserMediator"
    MEDIATOR_NAME = "UserMediator";
...
// 获取已注册感兴趣的通知列表
QList<QString> UserMediator::getListNotificationInterests()
{
...
// 返回处理好的更新操作
// 处理接受到的信息
void UserMediator::handleNotification(INotification *notification)
{
...
void UserMediator::changePwd(LoginParam *loginInfo)
{
    // 发送指令
